<!DOCTYPE html><html><head><link rel="stylesheet" href="assets/main.css"><script language="javascript" type="text/javascript" src="libraries/p5.js"></script><script language="javascript" type="text/javascript" src="libraries/p5.dom.js"></script></head><body><h1>string-width <a href="https://travis-ci.org/sindresorhus/string-width"><img src="https://travis-ci.org/sindresorhus/string-width.svg?branch=master" alt="Build Status"></a></h1><blockquote>
...
<h2>Install</h2><pre><code>$ npm install --save string-width
</code></pre><h2>Usage</h2><pre><code class="language-js">const stringWidth = require(&#39;string-width&#39;);
