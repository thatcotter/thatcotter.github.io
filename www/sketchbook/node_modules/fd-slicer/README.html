<!DOCTYPE html><html><head><link rel="stylesheet" href="assets/main.css"><script language="javascript" type="text/javascript" src="libraries/p5.js"></script><script language="javascript" type="text/javascript" src="libraries/p5.dom.js"></script></head><body><h1>fd-slicer</h1><p><a href="https://travis-ci.org/andrewrk/node-fd-slicer"><img src="https://travis-ci.org/andrewrk/node-fd-slicer.svg?branch=master" alt="Build Status"></a>
...
emitted if created from a buffer.</p></body></html>