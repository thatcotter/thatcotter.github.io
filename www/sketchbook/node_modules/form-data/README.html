...
<p><a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v2.1.2.svg?label=linux:0.12-6.x" alt="Linux Build"></a>
<a href="https://travis-ci.org/form-data/form-data"><img src="https://img.shields.io/travis/form-data/form-data/v2.1.2.svg?label=macos:0.12-6.x" alt="MacOS Build"></a>
<a href="https://ci.appveyor.com/project/alexindigo/form-data"><img src="https://img.shields.io/appveyor/ci/alexindigo/form-data/v2.1.2.svg?label=windows:0.12-6.x" alt="Windows Build"></a></p>
<p><a href="https://coveralls.io/github/form-data/form-data?branch=master"><img src="https://img.shields.io/coveralls/form-data/form-data/v2.1.2.svg?label=code+coverage" alt="Coverage Status"></a>
...
<h2>License</h2><p>Form-Data is released under the <a href="License">MIT</a> license.</p></body></html>