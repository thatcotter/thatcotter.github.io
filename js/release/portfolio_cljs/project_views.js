...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$columns$is_DASH_multiline,(function (){var iter__4523__auto__ = (function portfolio_cljs$project_views$other_media_grid_$_iter__26417(s__26418){
return (new cljs.core.LazySeq(null,(function (){
var s__26418__$1 = s__26418;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__26418__$1);
if(temp__5720__auto__){
var s__26418__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26418__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26418__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26420 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26419 = (0);
while(true){
if((i__26419 < size__4522__auto__)){
var path = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26419);
cljs.core.chunk_append(b__26420,(function (){var G__26421 = num_coll;
switch (G__26421) {
case (5):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26421)].join('')));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26420),portfolio_cljs$project_views$other_media_grid_$_iter__26417(cljs.core.chunk_rest(s__26418__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26420),null);
}
} else {
var path = cljs.core.first(s__26418__$2);
return cljs.core.cons((function (){var G__26422 = num_coll;
switch (G__26422) {
case (5):
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$column$is_DASH_one_DASH_third$progressive,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$justify_DASH_content,"center",cljs.core.cst$kw$overflow,"hidden",cljs.core.cst$kw$align_DASH_items,"center"], null)], null),portfolio_cljs.project_views.cell(path)], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26422)].join('')));

}
})(),portfolio_cljs$project_views$other_media_grid_$_iter__26417(cljs.core.rest(s__26418__$2)));
}
} else {
return null;
}
...
return iter__4523__auto__(path_list);
})()], null);
});
...
var iter__4523__auto__ = (function portfolio_cljs$project_views$other_media_placeholder_$_iter__26428(s__26429){
return (new cljs.core.LazySeq(null,(function (){
var s__26429__$1 = s__26429;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__26429__$1);
if(temp__5720__auto__){
var s__26429__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26429__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__26429__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__26431 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__26430 = (0);
while(true){
if((i__26430 < size__4522__auto__)){
var path = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__26430);
cljs.core.chunk_append(b__26431,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,portfolio_cljs.project_views.rand_supplement_image()], null)], null));

var G__26432 = (i__26430 + (1));
i__26430 = G__26432;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26431),portfolio_cljs$project_views$other_media_placeholder_$_iter__26428(cljs.core.chunk_rest(s__26429__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26431),null);
}
} else {
var path = cljs.core.first(s__26429__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,portfolio_cljs.project_views.rand_supplement_image()], null)], null),portfolio_cljs$project_views$other_media_placeholder_$_iter__26428(cljs.core.rest(s__26429__$2)));
}
} else {
return null;
}
...
return iter__4523__auto__(path_range);
});
...
var project = (function (){var fexpr__26434 = (function (){var G__26435 = cljs.core.cst$kw$project;
return (state.cljs$core$IFn$_invoke$arity$1 ? state.cljs$core$IFn$_invoke$arity$1(G__26435) : state.call(null,G__26435));
})();
return (fexpr__26434.cljs$core$IFn$_invoke$arity$1 ? fexpr__26434.cljs$core$IFn$_invoke$arity$1(portfolio_cljs.project_views.projects) : fexpr__26434.call(null,portfolio_cljs.project_views.projects));
})();
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h1$title,(function (){var G__26436 = cljs.core.cst$kw$title;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__26436) : project.call(null,G__26436));
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h2$subtitle,(function (){var G__26437 = cljs.core.cst$kw$subtitle;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__26437) : project.call(null,G__26437));
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$hero,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$hero_DASH_body,(function (){var G__26438 = cljs.core.cst$kw$hero;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__26438) : project.call(null,G__26438));
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,(function (){var G__26439 = cljs.core.cst$kw$description;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__26439) : project.call(null,G__26439));
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,portfolio_cljs.project_views.other_media((function (){var G__26440 = cljs.core.cst$kw$supplement_DASH_media;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__26440) : project.call(null,G__26440));
})())], null)], null);
});
