...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$columns$is_DASH_multiline,(function (){var iter__4324__auto__ = (function portfolio_cljs$project_views$other_media_grid_$_iter__24053(s__24054){
...
var path = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__24055);
cljs.core.chunk_append(b__24056,(function (){var G__24057 = num_coll;
switch (G__24057) {
case (5):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24057)].join('')));

}
})());

var G__24060 = (i__24055 + (1));
i__24055 = G__24060;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24056),portfolio_cljs$project_views$other_media_grid_$_iter__24053(cljs.core.chunk_rest(s__24054__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24056),null);
}
} else {
var path = cljs.core.first(s__24054__$2);
return cljs.core.cons((function (){var G__24058 = num_coll;
switch (G__24058) {
case (5):
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$column$is_DASH_one_DASH_third$progressive,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$justify_DASH_content,"center",cljs.core.cst$kw$overflow,"hidden",cljs.core.cst$kw$align_DASH_items,"center"], null)], null),portfolio_cljs.project_views.cell(path)], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24058)].join('')));

}
})(),portfolio_cljs$project_views$other_media_grid_$_iter__24053(cljs.core.rest(s__24054__$2)));
}
} else {
return null;
}
...
var iter__4324__auto__ = (function portfolio_cljs$project_views$other_media_placeholder_$_iter__24064(s__24065){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__24067,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,portfolio_cljs.project_views.rand_supplement_image()], null)], null));

var G__24068 = (i__24066 + (1));
i__24066 = G__24068;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__24067),portfolio_cljs$project_views$other_media_placeholder_$_iter__24064(cljs.core.chunk_rest(s__24065__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__24067),null);
}
} else {
var path = cljs.core.first(s__24065__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,portfolio_cljs.project_views.rand_supplement_image()], null)], null),portfolio_cljs$project_views$other_media_placeholder_$_iter__24064(cljs.core.rest(s__24065__$2)));
}
} else {
return null;
}
...
var project = (function (){var fexpr__24070 = (function (){var G__24071 = cljs.core.cst$kw$project;
return (state.cljs$core$IFn$_invoke$arity$1 ? state.cljs$core$IFn$_invoke$arity$1(G__24071) : state.call(null,G__24071));
})();
return (fexpr__24070.cljs$core$IFn$_invoke$arity$1 ? fexpr__24070.cljs$core$IFn$_invoke$arity$1(portfolio_cljs.project_views.projects) : fexpr__24070.call(null,portfolio_cljs.project_views.projects));
})();
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h1$title,(function (){var G__24072 = cljs.core.cst$kw$title;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__24072) : project.call(null,G__24072));
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h2$subtitle,(function (){var G__24073 = cljs.core.cst$kw$subtitle;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__24073) : project.call(null,G__24073));
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$hero,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$hero_DASH_body,(function (){var G__24074 = cljs.core.cst$kw$hero;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__24074) : project.call(null,G__24074));
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,(function (){var G__24075 = cljs.core.cst$kw$description;
return (project.cljs$core$IFn$_invoke$arity$1 ? project.cljs$core$IFn$_invoke$arity$1(G__24075) : project.call(null,G__24075));
})()], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$section$section,portfolio_cljs.project_views.other_media((function (){var G__24076 = cljs.core.cst$kw$supplement_DASH_media;
