...
(defn body []
    [:div.content.columns.is-centered
     [:section.hero.is-medium.is-bold.column.is-half-desktop.is-three-quarters-tablet.is-full-mobile
      [:div.hero-body
       ...
       [:p "For my day job, I'm currently a creative technologist at Local Projects. I also teach graduate-level courses at schools like Parsons, usually teaching students how to make art, games, and installations with code. When I'm not coding for money, I'm also involved with " [:a {:href "http://livecode.nyc/" :target "none"} "LiveCode.NYC"] ", a collective of tech artist who use live programming to create audio-visual performances."]
       [:p "This website was made using "[:a {:href "http://reagent-project.github.io/" :target "none"} "Reagent"]", a Clojurescript library that interfaces with React. The source code for this site can be found here."]]]])
