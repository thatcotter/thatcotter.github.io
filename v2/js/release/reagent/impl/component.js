...
if((i < len)){
var k = (ks[i]);
var G__26854 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__26855 = (i + (1));
m = G__26854;
i = G__26855;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__26856 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__26856) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__26856));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__26858 = c;
var G__26858__$1 = (((G__26858 == null))?null:G__26858.prototype);
if((G__26858__$1 == null)){
return null;
} else {
return (G__26858__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__26860 = c;
var G__26860__$1 = (((G__26860 == null))?null:G__26860.prototype);
if((G__26860__$1 == null)){
return null;
} else {
return (G__26860__$1["render"]);
}
})() == null))));
});
...
return (function() { 
var G__26864__delegate = function (args){
var G__26862 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__26862) : reagent.impl.component.as_element.call(null,G__26862));
};
...
while (G__26865__i < G__26865__a.length) {G__26865__a[G__26865__i] = arguments[G__26865__i + 0]; ++G__26865__i;}
  args = new cljs.core.IndexedSeq(G__26865__a,0,null);
} 
...
var _STAR_current_component_STAR_26868 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_26868;
}});
...
var G__26869 = key;
var G__26869__$1 = (((G__26869 instanceof cljs.core.Keyword))?G__26869.fqn:null);
switch (G__26869__$1) {
...
return ((function (G__26869,G__26869__$1){
...
var c = this;
var G__26874_26876 = (c["cljsRatom"]);
if((G__26874_26876 == null)){
} else {
reagent.ratom.dispose_BANG_(G__26874_26876);
}
...
var renders_26878 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_26879 = cljs.core.first(cljs.core.vals(renders_26878));
if((cljs.core.count(renders_26878) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_26878))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_26879)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_26879], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__26877 = name;
switch (G__26877) {
case "":
...
var G__26882 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__26882) : reagent.impl.component.global$module$create_react_class.call(null,G__26882));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__26883 = fiber;
...
var parent = (function (){var G__26884 = fiber;
if((G__26884 == null)){
return null;
} else {
return (G__26884["return"]);
}
})();
var path = (function (){var G__26885 = parent;
var G__26885__$1 = (((G__26885 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__26885) : reagent.impl.component.fiber_component_path.call(null,G__26885)));
if((G__26885__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26885__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__26887 = c;
if((G__26887 == null)){
return null;
} else {
return (G__26887["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__26888._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__26890 = c;
if((G__26890 == null)){
return null;
} else {
return (G__26890["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__26892 = c;
if((G__26892 == null)){
return null;
} else {
return G__26892._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__26894 = instance;
if((G__26894 == null)){
return null;
} else {
return (G__26894["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__26895 = instance;
if((G__26895 == null)){
return null;
} else {
return G__26895._currentElement;
}
}
})();
var name = (function (){var G__26896 = elem;
var G__26896__$1 = (((G__26896 == null))?null:(G__26896["type"]));
if((G__26896__$1 == null)){
return null;
} else {
return (G__26896__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__26898 = elem;
if((G__26898 == null)){
return null;
} else {
return (G__26898["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__26899._owner;
}
}
})();
var path = (function (){var G__26900 = owner;
var G__26900__$1 = (((G__26900 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__26900) : reagent.impl.component.component_path.call(null,G__26900)));
if((G__26900__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26900__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__26901 = c;
var G__26901__$1 = (((G__26901 == null))?null:G__26901.constructor);
if((G__26901__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__26901__$1);
}
}
})();
