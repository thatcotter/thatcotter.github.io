...
var G__46634 = (function (){var G__46632 = sb;
G__46632.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__46632;
})();
var G__46635 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__46634;
ch = G__46635;
continue;
}
...
var temp__5455__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__46636 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46636,ch);
...
var vec__46644 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46644,(0),null);
var start_column = cljs.core.nth.call(null,vec__46644,(1),null);
...
var G__46648 = ((!((mret === rdr)))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__46648;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__46647 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46647,ch);

return G__46647;
})(),true,null,opts);
var G__46649 = ((!((o === rdr)))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__46649;
continue;
}
}
...
var vec__46650 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46650,(0),null);
var start_column = cljs.core.nth.call(null,vec__46650,(1),null);
...
var sb = (function (){var G__46653 = (new goog.string.StringBuffer());
G__46653.append(initch);
...
var G__46655 = (function (){var G__46654 = sb;
G__46654.append(ch);

return G__46654;
})();
var G__46656 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46655;
ch = G__46656;
continue;
}
...
while(true){
var G__46659 = ch;
if(cljs.core._EQ_.call(null,null,G__46659)){
...
if(cljs.core._EQ_.call(null,"\\",G__46659)){
var G__46662 = (function (){var G__46660 = sb;
G__46660.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__46660;
})();
var G__46663 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46662;
ch = G__46663;
continue;
} else {
...
var G__46664 = (function (){var G__46661 = sb;
G__46661.append(ch);

return G__46661;
})();
var G__46665 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46664;
ch = G__46665;
continue;
...
var G__46669 = rdr;
cljs.tools.reader.edn.read.call(null,G__46669,true,null,true);
...
var temp__5455__auto__ = (function (){var G__46670 = token;
var G__46670__$1 = (((G__46670 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46670));
if((G__46670__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46670__$1);
}
})();
if(cljs.core.truth_(temp__5455__auto__)){
...
var G__46671 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__46671)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__46671)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__46671)){
...
cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46678,reader){
var map__46679 = p__46678;
var map__46679__$1 = ((((!((map__46679 == null)))?(((((map__46679.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46679.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46679):map__46679);
var opts = map__46679__$1;
var eof = cljs.core.get.call(null,map__46679__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
//# sourceMappingURL=edn.js.map?rel=1545318904691
