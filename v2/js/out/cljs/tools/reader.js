...
var G__46509 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__46509;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__46510 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46510,ch);
...
if(("\\" === ch__$1)){
var ch_46511__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
...
var G__46512 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__46512;
continue;
}
}
...
var vec__46520 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46520,(0),null);
var start_column = cljs.core.nth.call(null,vec__46520,(1),null);
...
var G__46523 = cljs.core.conj_BANG_.call(null,a,form);
a = G__46523;
continue;
}
}
...
var _STAR_read_delim_STAR_46524 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_46524;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__46525 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46525,(0),null);
var start_column = cljs.core.nth.call(null,vec__46525,(1),null);
...
var vec__46528 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46528,(0),null);
var end_column = cljs.core.nth.call(null,vec__46528,(1),null);
...
var vec__46531 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46531,(0),null);
var start_column = cljs.core.nth.call(null,vec__46531,(1),null);
...
var vec__46534 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46534,(0),null);
var end_column = cljs.core.nth.call(null,vec__46534,(1),null);
...
var vec__46537 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46537,(0),null);
var start_column = cljs.core.nth.call(null,vec__46537,(1),null);
...
var vec__46540 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46540,(0),null);
var end_column = cljs.core.nth.call(null,vec__46540,(1),null);
...
var G__46545 = (function (){var G__46544 = sb;
G__46544.append(ch);

return G__46544;
})();
var G__46546 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__46545;
ch = G__46546;
continue;
}
...
switch (G__46549) {
case "\\":
var G__46553 = (function (){var G__46550 = sb;
G__46550.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__46550;
})();
var G__46554 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46553;
ch = G__46554;
continue;
...
break;
default:
var G__46555 = (function (){var G__46551 = sb;
G__46551.append(ch);

return G__46551;
})();
var G__46556 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__46555;
ch = G__46556;
continue;
...
var vec__46557 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46557,(0),null);
var end_column = cljs.core.nth.call(null,vec__46557,(1),null);
...
var vec__46560 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46560,(0),null);
var column = cljs.core.nth.call(null,vec__46560,(1),null);
...
var vec__46565 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46565,(0),null);
var column = cljs.core.nth.call(null,vec__46565,(1),null);
...
var vec__46570 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__46570,(0),null);
var column = cljs.core.nth.call(null,vec__46570,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__46575 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__46575,(0),null);
var start_column = cljs.core.nth.call(null,vec__46575,(1),null);
...
var vec__46578 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__46578,(0),null);
var end_column = cljs.core.nth.call(null,vec__46578,(1),null);
...
var G__46581 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__46581,true,null,opts,pending_forms);
...
var G__46582 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__46582)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__46582)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__46582)){
...
var _STAR_suppress_read_STAR_46583 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46583;
}});
...
var G__46584 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__46584,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__46584,rdr,first_line);
...
var G__46588 = matched;
var G__46589 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__46588;
finished = G__46589;
continue;
} else {
...
var _STAR_suppress_read_STAR_46590 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_46590;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env46591 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__46592 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__46592,"(");
...
var G__46593 = (i + (1));
var G__46594 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3949__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env46591;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__46595 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__46595);
...
var G__46596 = cljs.core.next.call(null,s__$1);
var G__46597 = ret;
s__$1 = G__46596;
r = G__46597;
continue;
...
var G__46598 = cljs.core.next.call(null,s);
var G__46599 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__46598;
key_vals = G__46599;
continue;
} else {
...
var gensym_env46603 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env46603;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__46604 = token;
var G__46604__$1 = (((G__46604 == null))?null:cljs.core.subs.call(null,G__46604,(1)));
var G__46604__$2 = (((G__46604__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46604__$1));
var G__46604__$3 = (((G__46604__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46604__$2));
var G__46604__$4 = (((G__46604__$3 == null))?null:cljs.core.symbol.call(null,G__46604__$3));
if((G__46604__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__46604__$4);
}
})():(function (){var G__46605 = token;
var G__46605__$1 = (((G__46605 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__46605));
if((G__46605__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__46605__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__46616,reader){
...
var eof = cljs.core.get.call(null,map__46617__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4531__auto___46625 = arguments.length;
var i__4532__auto___46626 = (0);
while(true){
if((i__4532__auto___46626 < len__4531__auto___46625)){
args__4534__auto__.push((arguments[i__4532__auto___46626]));

var G__46627 = (i__4532__auto___46626 + (1));
i__4532__auto___46626 = G__46627;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq46623){
var G__46624 = cljs.core.first.call(null,seq46623);
var seq46623__$1 = cljs.core.next.call(null,seq46623);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46624,seq46623__$1);
});


//# sourceMappingURL=reader.js.map?rel=1545318904450
