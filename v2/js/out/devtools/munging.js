...
var o42085 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42085["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42086 = temp__5455__auto____$1;
return (o42086["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28494__auto__ = f;
return (o__28494__auto__["toString"]).call(o__28494__auto__);
} else {
return "";
}
}catch (e42087){var _ = e42087;
return "";
}});
...
try{var o__28494__auto___42089 = t;
(o__28494__auto___42089["cljs$lang$ctorPrWriter"]).call(o__28494__auto___42089,t,writer);
}catch (e42088){var __42090 = e42088;
}
...
var char_code = (function (){var o__28494__auto__ = (new String(char$));
return (o__28494__auto__["charCodeAt"]).call(o__28494__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28494__auto__ = String;
return (o__28494__auto__["fromCharCode"]).call(o__28494__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42091 = num_code;
switch (G__42091) {
case (1):
return (185);
...
var o__28494__auto__ = String;
return (o__28494__auto__["fromCharCode"]).call(o__28494__auto__,superscript_code);
});
/**
...
}catch (e42093){var _e__28501__auto__ = e42093;
return false;
}})())){
...
var vec__42094 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__42094,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o42097 = temp__5455__auto__;
var temp__5455__auto____$1 = (o42097["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o42098 = temp__5455__auto____$1;
return (o42098["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___42105 = arguments.length;
var i__4532__auto___42106 = (0);
while(true){
if((i__4532__auto___42106 < len__4531__auto___42105)){
args__4534__auto__.push((arguments[i__4532__auto___42106]));

var G__42107 = (i__4532__auto___42106 + (1));
i__4532__auto___42106 = G__42107;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42101){
var vec__42102 = p__42101;
var ns_detector = cljs.core.nth.call(null,vec__42102,(0),null);
...
var G__42108 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__42109 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__42108;
remaining_tokens = G__42109;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42099){
var G__42100 = cljs.core.first.call(null,seq42099);
var seq42099__$1 = cljs.core.next.call(null,seq42099);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42100,seq42099__$1);
});
...
var vec__42113 = cljs.core.split_with.call(null,(function (p1__42112_SHARP_){
return cljs.core.not_EQ_.call(null,p1__42112_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__42113,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__42113,(1),null);
...
var vec__42116 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__42116,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__42116,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__42119 = cljs.core.rest.call(null,remaining_tokens);
var G__42120 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__42119;
name_tokens = G__42120;
continue;
} else {
...
var vec__42123 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__42123,(0),null);
var arity = cljs.core.nth.call(null,vec__42123,(1),null);
var vec__42126 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__42126,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__42126,(1),null);
var vec__42129 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__42129,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__42129,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__42129,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__42129,(3),null);
...
var vec__42135 = result;
var munged_ns = cljs.core.nth.call(null,vec__42135,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__42135,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__42135,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__42135,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__42135,(4),null);
var arity = cljs.core.nth.call(null,vec__42135,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__42139 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__42139,(0),null);
var args = cljs.core.nth.call(null,vec__42139,(1),null);
var vec__42142 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__42142,(0),null);
var name = cljs.core.nth.call(null,vec__42142,(1),null);
...
var G__42145 = (arity + (1));
var G__42146 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42147){
var vec__42148 = p__42147;
var arity = cljs.core.nth.call(null,vec__42148,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__42148,(1),null);
...
return cljs.core.get.call(null,arities,p1__42151_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__42152_SHARP_){
return cljs.core.drop.call(null,(2),p1__42152_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___42159 = arguments.length;
var i__4532__auto___42160 = (0);
while(true){
if((i__4532__auto___42160 < len__4531__auto___42159)){
args__4534__auto__.push((arguments[i__4532__auto___42160]));

var G__42161 = (i__4532__auto___42160 + (1));
i__4532__auto___42160 = G__42161;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42155){
var vec__42156 = p__42155;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__42156,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42153){
var G__42154 = cljs.core.first.call(null,seq42153);
var seq42153__$1 = cljs.core.next.call(null,seq42153);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42154,seq42153__$1);
});
...
var map__42164 = options;
var map__42164__$1 = ((((!((map__42164 == null)))?(((((map__42164.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42164.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__42164):map__42164);
var include_ns_QMARK_ = cljs.core.get.call(null,map__42164__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__42164__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__42164__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__42164__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42165 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__42165,(0),null);
var fn_name = cljs.core.nth.call(null,vec__42165,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__42165,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__42165,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__42165,(4),null);
var arity = cljs.core.nth.call(null,vec__42165,(5),null);
...
var o__28494__auto__ = f;
return (o__28494__auto__["getBasis"]).call(o__28494__auto__);
});
/**
...
}catch (e42169){var _e__28501__auto__ = e42169;
...
var G__42170 = (obj[cljs.core.first.call(null,path)]);
var G__42171 = cljs.core.rest.call(null,path);
obj = G__42170;
path = G__42171;
continue;
} else {
...
return (function (accum,p__42172){
var vec__42173 = p__42172;
var bit = cljs.core.nth.call(null,vec__42173,(0),null);
var protocol = cljs.core.nth.call(null,vec__42173,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42176){
var vec__42177 = p__42176;
var ns = cljs.core.nth.call(null,vec__42177,(0),null);
var name = cljs.core.nth.call(null,vec__42177,(1),null);
var selector = cljs.core.nth.call(null,vec__42177,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__42182,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__42182,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__42182,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__42180_SHARP_){
return (obj[cljs.core.first.call(null,p1__42180_SHARP_)]);
});})(name,sorted_matches,vec__42182,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1545318896111
