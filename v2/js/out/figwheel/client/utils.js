...
return (new CustomEvent(event_name,(function (){var obj46769 = {"detail":data};
return obj46769;
})()));
} else {
...
var f = (function (){var pred__46776 = cljs.core._EQ_;
var expr__46777 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46776.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46777))){
return ((function (pred__46776,expr__46777){
return (function (p1__46770_SHARP_){
return console.warn(p1__46770_SHARP_);
});
;})(pred__46776,expr__46777))
} else {
if(cljs.core.truth_(pred__46776.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46777))){
return ((function (pred__46776,expr__46777){
return (function (p1__46771_SHARP_){
return console.debug(p1__46771_SHARP_);
});
;})(pred__46776,expr__46777))
} else {
if(cljs.core.truth_(pred__46776.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46777))){
return ((function (pred__46776,expr__46777){
return (function (p1__46772_SHARP_){
return console.error(p1__46772_SHARP_);
});
;})(pred__46776,expr__46777))
} else {
return ((function (pred__46776,expr__46777){
return (function (p1__46773_SHARP_){
return console.log(p1__46773_SHARP_);
});
;})(pred__46776,expr__46777))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46780){
var map__46781 = p__46780;
var map__46781__$1 = ((((!((map__46781 == null)))?(((((map__46781.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46781.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__46781):map__46781);
var opts = map__46781__$1;
var eval_fn = cljs.core.get.call(null,map__46781__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__46783_SHARP_){
return new_def.callback(p1__46783_SHARP_);
});})(new_def))
);
...
return (function (p__46784){
var vec__46785 = p__46784;
var ky = cljs.core.nth.call(null,vec__46785,(0),null);
var v = cljs.core.nth.call(null,vec__46785,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1545318904893
